...
import com.cts.activitystream.repository.UserCircleRepository;
...
public class UserCircleServiceImpl implements UserCircleService {
	/*
	 * Autowiring should be implemented for the UserCircleRepository. Please
	...
	public boolean addUser(String username, String circleName) {
		...
		UserCircle userCircle = userCircleRepository.getUsernameAndCircleName(
				username, circleName);
