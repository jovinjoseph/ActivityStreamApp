...
public class CircleController {
	...
	*/
	@PostMapping(value ="/api/circle", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	*/
	@GetMapping(value = "/api/circle", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	*/
	@GetMapping(value = "/api/circle/search/{searchString}", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
